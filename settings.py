...
TENCENT_APP_ID = '1106851281'
TENCENT_APP_KEY = 'L9bpjMudBz1Ttmtm'

# Baidu API ID & Key (DEV)
BAIDU_APP_ID = '11343310'
BAIDU_API_KEY = 'yVinrzkVTxoOrF2EjkvX1507'
BAIDU_SECRET_KEY = 'nTW0dApPb71pqCZTHjGCsvllXRrkpPYS'

# JD API ID & Key (DEV)
JD_APP_ID = 'd3e558705a1c093a369e9671065483bd'
JD_APP_KEY = '3e7867f567fbbbca1ec4182e6146e935'

# Netease API ID & Key (DEV)
NETEASE_APP_ID = '100000000317'
NETEASE_API_KEY = 'Wko0J3GuV917Myds'

# Face++ API ID & Key (DEV)
FACEPLUSPLUS_API_Key = '53pZ3_8e_rqi9k1_1CLFr-DDHkUaTI_o'
FACEPLUSPLUS_API_Secret = '34CHt57mkuNORei1FGf5rMMUFjzRczCX'
